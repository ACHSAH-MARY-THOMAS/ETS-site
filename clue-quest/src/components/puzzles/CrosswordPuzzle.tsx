...
export const CrosswordPuzzle = ({ onSolve, level = 9 }: CrosswordPuzzleProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto p-4 md:pb-20">
            ...
            {crosswordComplete && (
                <div className="w-full max-w-md mx-auto mt-8 pb-10">
                    <p className="text-xs md:text-sm font-['Press_Start_2P'] text-foreground uppercase text-center mb-4">
