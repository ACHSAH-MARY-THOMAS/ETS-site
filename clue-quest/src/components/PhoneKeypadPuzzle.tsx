...
import { CheckCircle, XCircle, Lightbulb, Phone, User, Delete } from "lucide-react";
...
export const PhoneKeypadPuzzle = ({ onSolve }: PhoneKeypadPuzzleProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-3 flex-shrink-0">
                <h2 className="text-sm md:text-base text-primary mb-2" style={{ fontFamily: 'Georgia, serif', fontStyle: 'italic' }}>
                    You've just found a primitive comms device:
                </h2>
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed px-4 font-medium" style={{ fontFamily: 'Courier New, monospace' }}>
            ...
            <div className="flex-1 flex gap-3 min-h-0 overflow-hidden">
                ...
                >
                    ...
                    <div className="text-center mb-1">
                        <span className="text-[7px] text-gray-500 tracking-[0.3em]" style={{ fontFamily: 'Arial, sans-serif' }}>NOKIA</span>
                    </div>
